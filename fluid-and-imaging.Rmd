...
NoCite(bib, c('calibFit', 'davidian1990', 'Youden', 'pROC', 'ctree', 
  ...
  'johnson2007adjusting', 'beer2020longitudinal'))
...
```{r ROC_same, fig.width=5, fig.height=5}
f1 <- function(x){
...
AUC1 = AUC2 = `r roc_1$auc` in this case, with 95% CI ( `r ci(roc_1)[c(1,3)]` )
...
```{r prep-data-for-combat, echo = FALSE}
...
`r Citet(bib=bib, c('johnson2007adjusting', 'beer2020longitudinal'))`
